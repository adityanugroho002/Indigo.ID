...
<div class="container">
    ...
    <form method="GET" action="{{ route('daftar_lomba') }}" class="mb-4">
            ...
            <div class="card h-100 shadow">
                ...
                <div class="card-body d-flex flex-column">
                    ...
                    <div class="d-flex justify-content-between align-items-center mt-auto">
                        <button type="button" class="btn btn-info" data-toggle="modal" data-target="#detailModal{{ $l->id }}" style="flex-grow: 1; margin-right: 8px;">
                            Detail
                        </button>
                        <a href="{{ asset($l->poster) }}" download class="btn btn-primary" style="flex-grow: 1;">Unduh Poster</a>
                    </div>
                </div>
            </div>
        </div>
